...
<h2><strong>Data Anggota Serikat:</strong></h2>
<div class="col-md-12">
  <a class="btn btn-primary" href="/executors/create">Add</a>
</div>
      ...
      @foreach ($users as $user)
        <tr>
          ...
          <td><a href="/executors/{{$user->id}}">Edit</a>
            ...
            <form action="/executors/{{$user->id}}" method="POST" id="delete-form-{{ $user->id }}" style="display: none;">
              @csrf
              @method('DELETE')
